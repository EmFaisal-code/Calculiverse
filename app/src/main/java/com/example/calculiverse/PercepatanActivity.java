...
public class PercepatanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddFavorite.setOnClickListener(v -> {
            boolean isFavorit = db.favoritDao().isFavorit("Percepatan");
            if (isFavorit) {
                db.favoritDao().deleteByKategoriAndSubkategori("Pengonversi satuan", "Percepatan");
                Toast.makeText(this, "Dihapus dari Favorit", Toast.LENGTH_SHORT).show();
            } else {
                Favorit favorit = new Favorit("Pengonversi satuan", "Percepatan");
